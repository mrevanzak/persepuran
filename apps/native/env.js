...
const PACKAGE = "app.mrevanzak.persepuran"; // package name
const NAME = "Persepuran"; // app name
const EXPO_ACCOUNT_OWNER = "mrevanzak"; // expo account owner
const EAS_PROJECT_ID = "605cec0b-623a-48b9-a6ae-1300d1133173"; // eas project id
const SCHEME = "persepuran"; // app scheme
